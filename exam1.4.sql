/*
 ...
 Source Schema         : exam1.4

 Target Server Type    : MySQL
 Target Server Version : 80032 (8.0.32)
 File Encoding         : 65001

 Date: 08/06/2023 14:18:14
*/
...
CREATE TABLE `exam_manage`  (
  ...
  `filepath` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL,
  PRIMARY KEY (`examCode`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20190018 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '考试管理表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of exam_manage
-- ----------------------------
INSERT INTO `exam_manage` VALUES (20190001, '2019年上期期末考试', '计算机网络', 1001, '2019-03-21', 120, '2018', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。', 'fd74e0ac-db75-4a5f-8b92-086470752204.png');
INSERT INTO `exam_manage` VALUES (20190002, '2019年上期期末考试', '数据库理论', 1002, '2019-03-07', 90, '2018', '2', '网络工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。', '9ea4b43f-3e03-41f1-9061-64387d477ec8.png');
INSERT INTO `exam_manage` VALUES (20190003, '2018年下期期末考试', '数据结构', 1003, '2019-02-27', 90, '2017', '1', '软件工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。', 'e88efed6-2cea-4b94-9b6f-10315011bea8.png');
INSERT INTO `exam_manage` VALUES (20190005, '2018年上期期末考试', '计算机导论', 1004, '2019-03-14', 90, '2018', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。', '6874906d-c8c2-4563-a92e-3d88a505c5f3.png');
INSERT INTO `exam_manage` VALUES (20190006, '2017年上期期末考试', '软件工程', 1005, '2019-03-21', 120, '2018', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。', 'fb879bf4-a129-4230-aade-4cc6002a980b.png');
INSERT INTO `exam_manage` VALUES (20190007, '2018年上期期末考试', '操作系统', 1006, '2019-03-13', 120, '2018', '2', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。', '61b1c9d7-39a1-4c80-a4d3-e0df4b4e70d4.png');
INSERT INTO `exam_manage` VALUES (20190008, '2018年下期期末考试', 'C语言', 1007, '2019-03-13', 120, '2018', '1', '信息工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。', '638db781-de8e-4950-8bcb-5a723232beec.png');
INSERT INTO `exam_manage` VALUES (20190009, '2018年上期期末考试', '高等数学', 1008, '2019-03-07', 90, '2018', '1', '信息工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。', '2995a5c2-44d4-4dd6-b2b9-6157617131ba.png');
INSERT INTO `exam_manage` VALUES (20190013, '测试', '测试', 1009, '2019-04-24', 120, '2017', NULL, '测试', '测试', 100, '期末考试', '请不要带与考试无关的书籍。', '7df70a57-d3a6-42e3-8547-ee50ddfd3997.jpg');
INSERT INTO `exam_manage` VALUES (20190015, '这是毕业设计', '毕业设计', 1011, '2023-05-02', 2, '2019', NULL, '软件工程', '国教院', 100, '2', '好好加油', 'dff9765b-e5e2-44d8-9728-b5b53005c15f.png');
INSERT INTO `exam_manage` VALUES (20190016, '云计算大大大大', '云计算', 1012, '2023-05-18', 22, '22', NULL, '的撒大', '软件工程', 100, '大撒大撒', '加油', '73c70681-37ff-4227-81d9-50013bedce6b.png');
INSERT INTO `exam_manage` VALUES (20190017, '计算机考试', '计算机考试', 1013, '2023-06-07', 100, '2019', NULL, '软件', '软件学院', 100, '闭卷', NULL, '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 10031 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '填空题题库' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `fill_question` VALUES (10029, '计算机网络', '1', '11', '11', 2, '1', '1');
INSERT INTO `fill_question` VALUES (10030, '1', '1', '1', '1', 2, '2', '1');

-- ----------------------------
-- Table structure for jianda_question
-- ----------------------------
DROP TABLE IF EXISTS `jianda_question`;
CREATE TABLE `jianda_question`  (
  `questionId` int NOT NULL AUTO_INCREMENT COMMENT '试题编号',
  `subject` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '考试科目',
  `question` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '试题内容',
  `analysis` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '试题解析',
  `section` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '所属章节',
  `level` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '等级',
...
-- ----------------------------
-- Records of jianda_question
-- ----------------------------
INSERT INTO `jianda_question` VALUES (1, '计算机网络', '测试简答题目', '测试简答解析', '简答章节测试', '1', 10, NULL);
INSERT INTO `jianda_question` VALUES (2, '计算机网络', '测试简答2', '', NULL, '', NULL, NULL);
INSERT INTO `jianda_question` VALUES (3, '计算机网络', 'dsfsdfasf', 'dasfdasfdafa', '2', '3', NULL, NULL);
INSERT INTO `jianda_question` VALUES (4, '测试', 'weqwewqewqsad', 'dsadadwqewqe', '123', '3', NULL, NULL);
INSERT INTO `jianda_question` VALUES (5, 'C语言', '请说出一系列软件编程的语言', '软件编程的语言为java，python，c，c++', '1', '2', NULL, NULL);
INSERT INTO `jianda_question` VALUES (6, 'C语言', '呃呃呃呃呃呃呃呃呃呃呃呃呃呃呃呃呃呃呃', '11111111111111111111111111111111111111111111111111', '11', '3', NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '留言表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `multi_question` VALUES (10033, '计算机网络', '11', '1', '1', '1', '1', 'A', '1', 2, '1', '1');
INSERT INTO `multi_question` VALUES (10034, '计算机网络', '1', '1', '1', '1', '1', 'A', '1', 2, '1', '1');
...
-- Records of notice
-- ----------------------------
INSERT INTO `notice` VALUES (3, 'test', 'test', '2023-05-14 20:30:14', '2023-05-14 20:31:45', 1);
INSERT INTO `notice` VALUES (5, 'test1', 'test1test1test1test1test1test1test1test1', '2023-05-14 20:34:14', '2023-05-14 20:34:14', 0);
INSERT INTO `notice` VALUES (6, 'test3', 'test3test3test3', '2023-05-14 20:38:07', '2023-05-14 20:38:07', 0);
...
INSERT INTO `paper_manage` VALUES (1010, 1, 10006);
INSERT INTO `paper_manage` VALUES (1010, 2, 10023);
INSERT INTO `paper_manage` VALUES (1010, 3, 10005);
INSERT INTO `paper_manage` VALUES (1010, 2, 10030);
INSERT INTO `paper_manage` VALUES (1011, 1, 10034);
INSERT INTO `paper_manage` VALUES (1011, 2, 10030);
INSERT INTO `paper_manage` VALUES (1011, 1, 10033);
...
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '回复表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 33 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '成绩管理表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `score` VALUES (32, 20190001, 20155011, '计算机网络', NULL, 0, NULL, '2023-05-14');
...
CREATE TABLE `student`  (
  ...
  `tel` varchar(11) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL COMMENT '电话号码',
...
) ENGINE = InnoDB AUTO_INCREMENT = 20155021 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '学生信息表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `student` VALUES (20155009, '1', NULL, NULL, NULL, NULL, '18888888988', NULL, '123456', NULL, '1', '2');
INSERT INTO `student` VALUES (20155010, 'test1', '', '', '', '', '18888888888', '20081001@qqq.com', '123456', '', '', NULL);
INSERT INTO `student` VALUES (20155011, 'test211', '', '', '', '', '', '111@qq.com', '123456', '', '', '2');
INSERT INTO `student` VALUES (20155012, '', '', '', '', '', '18888888889', '', '123456', '', '', '2');
INSERT INTO `student` VALUES (20155013, '', '', '', '', '', '17777777777', '', '123456', '', '', '2');
INSERT INTO `student` VALUES (20155014, '', '', '', '', '', '16666666666', '', '123456', '', '', '2');
INSERT INTO `student` VALUES (20155015, '', '', '', '', '', '16666666665', '', '123456', '', '', '2');
INSERT INTO `student` VALUES (20155016, '', '', '', '', '', '16662345678', '', '123456', '', '', '2');
INSERT INTO `student` VALUES (20155017, '', '', '', '', '', '14444444444', '', '123456', '', '', '2');
INSERT INTO `student` VALUES (20155018, '', '', '', '', '', '15555555533', '', '123456', '', '', '2');
INSERT INTO `student` VALUES (20155019, '', '', '', '', '', '13333333333', '', '123456', '', '', '2');
INSERT INTO `student` VALUES (20155020, '', '', '', '', '', '12222222222', '', '123456', '', '', '2');
